 ...
 *Last Monthly :* ${lastmonthly > 0 ? '❌' : '✅'} 
 ...
 ⛔  *Banned:* No 
 `.trim() 
     conn.send2ButtonLoc(m.chat, await conn.resize(await (await fetch('https://telegra.ph/file/01138e7d5550e73fbb392.jpg')).buffer(), 300, 200), str, wm2, `Inventory`, `.inv`, `Profile`, `.profile`, m) 
     conn.reply(str) 
 } 
